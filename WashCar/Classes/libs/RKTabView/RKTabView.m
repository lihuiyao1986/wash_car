...
- (UIButton *)existingTabForTabItem:(RKTabItem *)tabItem {
...
- (UIButton *)tabForItem:(RKTabItem *)tabItem {
    UIButton *tab = [self existingTabForTabItem:tabItem];
    if (tab) {
        return tab;
    } else {
        tab = [[UIButton alloc] initWithFrame:[self frameForTab:tabItem]];
