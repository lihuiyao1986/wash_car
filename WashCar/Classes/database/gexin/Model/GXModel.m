...
- (NSMutableDictionary *)tableProperties
{
    ...
    //消息时间字段
    TablePropertyModel *noticeTimeProperty = [[TablePropertyModel alloc]init];
    noticeTimeProperty.fieldname = @"noticeTime";
    noticeTimeProperty.fieldvalue = self.noticeTime;
    noticeTimeProperty.fieldtype = sqlite_field_type_text;
    [dict setObject:noticeTimeProperty forKey:noticeTimeProperty.fieldname];
