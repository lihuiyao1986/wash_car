...
{
    //1.查询的sql
    NSString *sql = [NSString stringWithFormat:@"select * from %@ where mobile = :mobile",[self tableName]];
    
    //2.组装查询参数
    NSDictionary *params = [NSDictionary dictionaryWithObjectsAndKeys:[mobileno trimNull],@"mobile", nil];
