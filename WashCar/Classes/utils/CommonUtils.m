...
{
    clientId = [CommonUtils isStrEmpty:clientId] ? @"" : clientId;
    [UserDefaults setObject:clientId forKey:@"GEXIN_CLIENT_ID"];
    [UserDefaults synchronize];
}
...
{
    return [UserDefaults objectForKey:@"GEXIN_CLIENT_ID"];
}
