...
//拨打客服电话提示
#define callServiceTip @"拨打客服电话"
//刷新订单状态的提示
#define refreshOrderStatusTip @"正在刷新订单状态..."
...
//下单成功
#define orderSuccTitle @"成功下单"
#define orderSuccDesc @"成功下单，服务人员会在5分钟内联系您。"

//已接单
#define receiveOrderTitle @"已接单"
#define receiveOrderDesc @"跑男已接单，跑男飞奔而来..."

//到达停车位置
#define arrivalTitle @"到达停车位置"
#define arrivalDesc @"跑男已到达停车点，洗车前跑男会仔细检查车辆并拍照。"
#define arrivalPicBtnTitle @"照片"

//正在洗车
#define washingcarTitle @"正在洗车"
#define washingcarDesc @"别人洗车的时间，我却用来喝咖啡，任性!"

//洗车完成
#define finishwashcarTitle @"洗车完成"
#define finishwashcarDesc @"请到现场，或者通过照片确认洗车效果"
#define finishwashcarPicBtnTitle @"照片"
...
-(void)initData
{
    ...
    order_success_model.title = orderSuccTitle;
    ...
    washing_car_model.title = washingcarTitle;
    ...
    washing_car_model.desc = washingcarDesc;
    [_data addObject:washing_car_model];

    //5.洗车完成
    PayDetailModel *finished_wash_model = [[PayDetailModel alloc]init];
    finished_wash_model.title = finishwashcarTitle;
    finished_wash_model.status = PayDetailStatus_Unfinished;
    finished_wash_model.desc = finishwashcarDesc;
    finished_wash_model.btnTitle = finishwashcarPicBtnTitle;
...
-(void)contactService
{
    [ApplicationDelegate showAlertWithTowBtns:nil message:callServiceTip doneBtnFinishBlock:^()
     {
...
-(UIView*)bottomView
{
    if (!_bottomView)
    {
        ...
        [_orderStatusTBView setHeaderRefreshingText:refreshOrderStatusTip];
